...
//!
//! Declares the `ClaimsBuilder` trait that the core builder satisfies.
//! Consumers do not use this type directly — fixture construction goes
//! through the concrete builder in `core/bearer/jwt/`.
