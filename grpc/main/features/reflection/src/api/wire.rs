...
mod tests {
    ...
    /// @covers: decode_varint, encode_varint — round-trip.
    #[test]
    ...
    /// @covers: decode_request — empty body returns Unknown.
    #[test]
    fn test_decode_request_empty_body_returns_unknown() {
        assert_eq!(decode_request(&[]).unwrap(), ReflectionRequest::Unknown);
    }

    /// @covers: decode_request — list_services field=7.
    #[test]
