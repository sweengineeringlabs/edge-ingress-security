...
use crate::api::types::reflection::reflection_service::{
...
use crate::api::types::reflection_codec::ReflectionCodec;
    ...
    fn test_handle_request_unknown_returns_invalid_argument_error() {
        ...
        match resp {
            ReflectionResponse::Error { error_code, .. } => {
                assert_eq!(
                    error_code,
                    crate::api::types::reflection::reflection_service::ERROR_CODE_INVALID_ARGUMENT
                );
            }
