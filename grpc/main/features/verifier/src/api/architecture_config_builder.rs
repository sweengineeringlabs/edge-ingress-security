//! Builder for architecture-level configuration loaded from `config/architecture.toml`.

use std::path::PathBuf;

/// Fluent builder for architecture configuration loading.
...
impl Default for ArchitectureConfigBuilder {
    fn default() -> Self {
        Self {
...
impl swe_edge_configbuilder::ConfigBuilder for ArchitectureConfigBuilder {
    fn name(&self) -> &str {
        &self.name
    }
