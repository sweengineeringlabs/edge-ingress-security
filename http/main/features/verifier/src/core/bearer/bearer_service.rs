...
use crate::api::bearer::BearerLayer;
use crate::api::bearer::BearerService;
use crate::api::error::HttpAuthError;
use crate::api::types::bearer::BearerServiceHelper;
use crate::api::types::verified_claims::VerifiedClaims;
...
/// Core impl marker for the bearer service tower integration.
#[expect(dead_code, reason = "SEA core/ impl anchor")]
pub(crate) struct BearerServiceCore;
