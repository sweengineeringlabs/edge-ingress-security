...
use swe_edge_ingress_tls::{ApplicationConfigBuilder, TlsSvc};

/// @covers: create_config_builder
#[test]
fn test_application_config_builder_is_config_builder_impl() {
    let builder: ApplicationConfigBuilder = TlsSvc::create_config_builder();
...
fn test_application_config_builder_alias_matches_configbuilder_impl() {
    let _b: ConfigBuilderImpl = TlsSvc::create_config_builder();
}
